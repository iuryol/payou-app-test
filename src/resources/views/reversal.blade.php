<x-app-layout>
    {{-- Alerta de sucesso --}}
    @if(session('success'))
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mx-auto mt-6 max-w-[800px]" role="alert">
    ...
    {{-- Alerta de erro --}}
    @if($errors->any())
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mx-auto mt-6 max-w-[800px]" role="alert">
    ...
    <div class="min-h-screen bg-slate-200 flex items-center justify-center py-10">
        <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-[800px]">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        @if($transaction->status === 'completed')
                                            ...
                                            <div id="modal-{{ $transaction->id }}" class="fixed inset-0 z-50 bg-black bg-opacity-40 flex items-center justify-center hidden">
